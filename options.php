...
// Standard Meta
	...
	$options[] = array(
		...
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'idealab'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		...
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'idealab'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'idealab'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'idealab'),
		'desc' => __('', 'idealab'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'idealab'),
		'desc' => __('', 'idealab'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'idealab'),
		'desc' => __('Application Name', 'idealab'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('Tile Color', 'idealab'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('Tile Image', 'idealab'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'idealab'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'idealab'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('twitter:site (@username of website)', 'idealab'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'idealab'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('twitter:description (maximum 200 characters)', 'idealab'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('twitter:url (url for the content)', 'idealab'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'idealab'),
		'desc' => __('og:title', 'idealab'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('og:description', 'idealab'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('og:url', 'idealab'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'idealab'),
		'desc' => __('og:image', 'idealab'),
	...
	*/
	...
	$options[] = array(
		...
		'options' => array(
			...
			'2col-fixed' => $imagepath . '2col.png',
			'3col-fixed' => $imagepath . '3col.png')
	);
